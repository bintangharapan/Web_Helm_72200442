...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/2.0.7/css/dataTables.dataTables.css" class="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    <title>.:Helm App - @yield('title'):.!</title>
  </head>
  <body>
    <div class="container-fluit">
        <!--Header-->
        <div class="row">
            <div class="col-md-12 bg-dark py-3">
            ...
            <div class="row mt-4">
                <div class="col-3">
                  <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link {{ ($key == "Helm") ? "active":"" }}" id="v-pills-profile-tab" href="helm">Helm</a>
